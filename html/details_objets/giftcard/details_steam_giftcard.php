...
<html lang="en">
    ...
    <body>
        ...
        <div class="all_items">
            <div id="img_wishlist">
                <img src="../../../images/category/steam.png" class="produit_image" alt="steam giftcard ">
            </div>
            <div class="titre_description">
                <h2 class="details">Carte Cadeau Steam :</h2>
                <p class="description_complete">Les cartes cadeaux et les codes de portemonnaie Steam fonctionnent comme des bons d'achat pouvant être utilisés sur Steam pour l'achat de jeux, de logiciels et tout autre article que vous pouvez acheter sur Steam.
                </p>
                </div>
            </div>
