...
<html lang="en">
    ...
    <body>
        ...
        <div class="all_items">
            <div id="img_wishlist">
                <img src="../../../images/category/paysafe.png" class="produit_image" alt="paysafe giftcard ">
            </div>
            <div class="titre_description">
                <h2 class="details">Carte Paysafe:</h2>
                <p class="description_complete">Paysafecard est une carte prépayée disponible auprès de milliers de détaillants au sein de l'Europe. A dépenser partout !
                </p>
                </div>
            </div>
