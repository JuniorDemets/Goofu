...
<html lang="en">
    ...
    <body>
        ...
        <div class="all_items">
            <div id="img_wishlist">
                <img src="../../../images/category/nintendo.png" class="produit_image" alt="nntendo giftcard ">
            </div>
            <div class="titre_description">
                <h2 class="details">Carte Cadeau nintendo :</h2>
                <p class="description_complete">Code numérique pour approvisionnement de compte Nintendo eShop Utilisable sur : • Nintendo Switch et sur la version européenne des consoles • Nintendo 3DS • Nintendo 3DS XL • Nintendo 2DS • New Nintendo 2DS XL • New Nintendo 3DS • New Nintendo 3DS XL ou Wii U.
                </p>
                </div>
            </div>
