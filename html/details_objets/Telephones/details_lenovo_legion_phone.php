...
<html lang="en">
    ...
    <body>
        ...
        <div class="all_items">
            <div id="img_wishlist">
                <img src="../../../images/category/tel_lenovo.png" class="produit_image" alt="lenovo phone">
            </div>
            <form action="....">
            ...
            <div class="titre_description">
                ...
                <p class="description_complete">
                                    Équipé du processeur incroyablement rapide Qualcomm® Snapdragon™ 865+ 5G, le Lenovo Legion Phone Duel est le 
                                    <br>
                                    premier téléphone de gaming à exploiter ces performances de CPU et GPU de pointe et à les livrer entre vos mains. Conservez 
                                    <br>
                                    une fréquence d’horloge de 3,09 Hz sans aucune limitation des performances.
                                    <br>
                                    Grâce à son architecture technologique révolutionnaire avec son concept à double cœur, le Lenovo Legion Phone Duel redéfinit l’environnement de jeu immersif. 
                                    <br>
                                    Sa double architecture sous-jacente comprend un double système 
                                    <br>
                                    de refroidissement liquide, deux batteries, une double charge et deux haut-parleurs. Équilibrez votre jeu par paires.
                </p>
                </div>
            </div>
